...
class Mall(models.Model):
    ...
    # ── Médias ──
    image = models.ImageField(upload_to='malls/', blank=True, null=True)
    bg_color = models.CharField(max_length=200, default="linear-gradient(135deg,#1a1a2e,#2d1f6e)",
    ...
    def save(self, *args, **kwargs):
        if not self.slug:
            self.slug = generate_unique_slug(Mall, self.name)
        super().save(*args, **kwargs)
